...
class PositionMapperTest {
    ...
    class ToSummaryDTO {
        ...
        void shouldMapPositionToSummaryDTO() {
            ...
            // When
            PositionSummaryDTO dto = mapper.toSummaryDTO(position);

            // Then
            assertThat(dto.symbol()).isEqualTo("AAPL");
            assertThat(dto.totalQuantity()).isEqualByComparingTo(BigDecimal.valueOf(100));
            ...
            assertThat(dto.currentPrice().amount()).isEqualByComparingTo(new BigDecimal("175.0000"));
    ...
    class ToDetailResponse {
        ...
        void shouldMapPositionToDetailResponseWithHoldings() {
            ...
            // When
            PositionDetailResponse dto = mapper.toDetailResponse(position, accountNames);

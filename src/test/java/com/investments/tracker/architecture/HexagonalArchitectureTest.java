 ...
 *
 * <p>Tests verify that: - Domain layer is pure (no framework dependencies) - Application layer
 * depends only on domain - Infrastructure layer is the only layer with framework dependencies - No

...
final class CucumberTestHelper {
     ...
     * but is no longer written to the database (prices are now in CurrentPriceProvider/Redis).
     */
     ...
     * No price is set in CurrentPriceProvider (callers should not populate it).
     */

 ...
 *
 * <p>Configuration: - Features: loaded from classpath (src/test/resources/features) - Glue: step
 * definitions in com.investments.tracker.cucumber.steps - Plugins: pretty output, HTML report, JSON
 * report
 *

 ...
 * The domain only reads prices through this interface; writing prices
 * is an infrastructure concern handled by the adapters directly.
 * </p>
 *
...
public interface CurrentPriceProvider {
    ...
    /**
     * Gets current prices for multiple instruments in a single call.
     * Only returns entries for symbols that have a known price.
     *
